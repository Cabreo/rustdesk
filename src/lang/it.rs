...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete "PSEHAssist"..."),
        ...
        ("install_tip", "A causa del Controllo Account Utente (UAC), "PSEHAssist" potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare RustDesk a livello di sistema."),
        ("Click to upgrade", "Aggiorna"),
        ("Click to download", "Download"),
        ("Click to update", "Aggiorna"),
        ("Configure", "Configura"),
        ("config_acc", "Per controllare il desktop dall'esterno, devi fornire a "PSEHAssist" il permesso 'Accessibilità'."),
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a "PSEHAssist" il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a "PSEHAssist" di usare il servizio 'Accessibilità'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio ["PSEHAssist" Input]."),
        ...
        ("Turned off", "Spegni"),
        ("Language", "Lingua"),
        ("Keep "PSEHAssist" background service", "Mantieni il servizio di RustDesk in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se vuoi disabilitare questa funzione, vai nelle impostazioni dell'applicazione "PSEHAssist", apri la sezione 'Batteria' e deseleziona 'Senza restrizioni'."),
        ...
        ("Show "PSEHAssist"", "Visualizza RustDesk"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a "PSEHAssist" 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione 'Registra audio' a "PSEHAssist"."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto selezioni 'OK' nella finestra UAC dell'esecuzione di "PSEHAssist"."),
        ...
        ("verify_rustdesk_password_tip", "Conferma password "PSEHAssist""),
        ...
        ("Exit", "Esci da "PSEHAssist""),
        ("Open", "Apri "PSEHAssist""),
        ...
        ("scam_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare "PSEHAssist" e di avviare il servizio, non procedere e riattacca subito."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Aggiorna "PSEHAssist" Server Pro alla versione {} o successiva!"),
        ...
        ("selinux_tip", "In questo dispositivo è abilitato SELinux, che potrebbe impedire il corretto funzionamento di "PSEHAssist" come lato controllato."),
        ...
        ("powered_by_me", "Alimentato da "PSEHAssist""),
        ...
        ("allow-only-conn-window-open-tip", "Consenti connessione solo se la finestra "PSEHAssist" è aperta"),
        ...
        ("floating_window_tip", "It helps to keep "PSEHAssist" background service"),
        ...
        ("About "PSEHAssist"", "Info su RustDesk"),
